                ...
                <tbody>
                    ...
                    @foreach ( $objects as $object )
                        <tr>
                            ...
                            @endforeach
                            <td>
                                <a class="btn btn-success" href="{{ route( Str::camel(Str::plural($layer)) . '.show', $object['id']) }}?with=tenantContracts;keys;appliances;maintenances;landlordPayments;landlordOtherSubjects;documents">查看</a>
