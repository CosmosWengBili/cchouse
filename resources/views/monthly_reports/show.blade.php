            ...
            <div class="card-body table-responsive">
                <div class="row justify-content-center monthly-report mt-3">
                    ...
                    <div class="col-12 text-right border-bottom border-dark">
                        <p class="mr-4">
                            {{$report_used_date['year'] - 1911}}年 <span
                                class="bg-highlight px-3 text-center">{{$report_used_date['month']}}</span>月份
                        </p>
                    </div>
                    {{-- Header end --}}
                    {{-- Meta data --}}
                    ...
                    <div class="col-2 bg-highlight px-3 text-center">
                        {{$report_used_date['next_month']}}月{{$data['meta']['rent_collection_time']}}日</div>
                    {{-- Meta data end --}}
                    {{-- Room data --}}
                    ...
                    <div class="col-12 row px-0 border border-dark">
                        ...
                        <div id="detail-data" class="col-10 align-self-start row px-0">
                            <input type="hidden" id="total_landlord_other_subject_id"
