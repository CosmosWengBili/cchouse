                ...
                <tbody>
                    ...
                    @foreach ( $objects as $object )
                        <tr>
                            ...
                            @endforeach
                            <td>
                                <a class="btn btn-success" href="{{ route( Str::camel($layer) . '.show', $object['id']) }}?with=maintenances;tenant;tenantPayments;tenantElectricityPayments;payLogs;companyIncomes;">查看</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
