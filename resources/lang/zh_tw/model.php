...
return [
    ...
    'ContactInfo' => [
        ...
        'info_type'        => '類別',
        'value'            => '資料',
        'contactable_type' => '聯絡人類型',
        'contactable_id'   => '聯絡人編號',
        'created_at'       => '建立時間',
        'updated_at'       => '更新時間',
    ],
    'Maintenance' => [
    ...
    'Building' => [
        ...
        'address'                           => '地址',
        'is_squatter'                       => '是否違建',
        'squatter_status'                   => '違建狀態',
        'decoration_needed'                 => '是否需裝修',
        'decoration_price'                  => '裝修價格',
        'building_code'                     => '物件代碼',
        'tax_number'                        => '稅籍編號',
        'building_type'                     => '物件類型',
        'floor'                             => '樓層',
        ...
        'accounting_group'                  => '管理組別',
        'commission_group'                  => '招租組別',
        'rental_receipt'                    => '租金收據',
    ...
    'LandlordOtherSubject' => [
        'landlord_other_subjects' => '雜支管理',
        'id'                      => '編號',
        'subject'                 => '科目',
        'subject_type'            => '科目類別',
        'income_or_expense'       => '收入支出',
        'expense_date'            => '費用日期',
        'amount'                  => '費用',
        'comment'                 => '備註',
        'is_invoiced'             => '是否開發票',
